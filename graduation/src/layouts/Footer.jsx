    ...
    return (
        <footer className="custom-footer">
            ...
            <div className="social-icons">
                <a href="https://www.linkedin.com/in/safa-yi%C4%9Fit-51b9101b7/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                ...
                <a href="https://github.com/safaygt" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
